...
public class UpdateContainer extends Storable {
	...
	protected double trackRecDist;
	// recorded distance downhill
	protected double trackRecDistDownhill;
	// recorded distance uphill
	protected double trackRecDistUphill;
	// recorded minimal altitude
	protected float trackRecAltMin;
	// recorded maximal altitude
	protected float trackRecAltMax;
	// recorded altitude downhill
	protected float trackRecAltDownhill;
	// recorded altitude uphill
	protected float trackRecAltUphill;
	// cumulative altitude value
	protected float trackRecAltCumulative;
	// already recorded times in ms
	protected long trackRecTime;
	// recorded time (only movement)
	protected long trackRecTimeMove;
	// average recorded speed
	protected float trackRecSpeedAvg;
	// average recorded speed for segments during movement
	protected float trackRecSpeedAvgMove;
	// maximal recorded speed
	protected float trackRecSpeedMax;
	// already recorded points
	protected int trackRecPoints;
    ...
    /**
     * Return container with all track recording parameters.
     * @return track recording parameters or 'null' if track recording is not active
     */
    public TrackRecordContainer getTrackRecordContainer() {
        if (isTrackRecRecording()) {
            return new TrackRecordContainer();
        }
        return null;
    }

    /**
     * Container with track recording parameters.
     */
	public class TrackRecordContainer {

        /**
         * Default private constructor.
         */
        private TrackRecordContainer() {
            // empty container
        }
        ...
        /**
         * Get current recorded distance.
         * @return recorded distance in metres
         */
        ...
        /**
         * Get current recorded distance downhill only.
         * @return recorded distance in metres
         */
        public double getDistanceDownhill() {
            return trackRecDistDownhill;
        }

        /**
         * Get current recorded distance uphill only.
         * @return recorded distance in metres
         */
        public double getDistanceUphill() {
            return trackRecDistUphill;
        }

        /**
         * Get current minimum altitude reached during recording.
         * @return minimum altitude in metres
         */
        ...
        /**
         * Get current maximum altitude reached during recording.
         * @return maximum altitude in metres
         */
        ...
        /**
         * Get cumulative altitude for downhill movement.
         * @return cumulative altitude in metres
         */
        public float getAltitudeDownhill() {
            return trackRecAltDownhill;
        }

        /**
         * Get cumulative altitude for uphill movement.
         * @return cumulative altitude in metres
         */
        ...
        /**
         * Get cumulative altitude for all altitude movements.
         * @return cumulative altitude in metres
         */
        public float getAltitudeCumulative() {
            return trackRecAltCumulative;
        }

        /**
         * Get current time spend by track recording.
         * @return time of track recording in ms
         */
        public long getTime() {
            return trackRecTime;
        }
        ...
        /**
         * Get current time spend by track recording only during movement.
         * @return time of track recording in ms
         */
        ...
        /**
         * Get average speed for current track recording.
        ...
        /**
         * Get average speed for current track recording, recorded only during movement.
         * @return average speed in m/s
         */
        public float getSpeedAvgMove() {
            return trackRecSpeedAvgMove;
        }

        /**
         * Get maximum speed for current track recording.
         * @return average speed in m/s
         */
        ...
        /**
         * Get amount of already recorded points.
         * @return amout of recorded points
         */
    ...
    public void reset() {
        ...
        trackRecProfileName = "";
        trackRecDist = 0.0;
        trackRecDistDownhill = 0.0;
        trackRecDistUphill = 0.0;
        trackRecAltMin = 0.0f;
        trackRecAltMax = 0.0f;
        trackRecAltDownhill = 0.0f;
        trackRecAltUphill = 0.0f;
        trackRecAltCumulative = 0.0f;
        trackRecTime = 0L;
        trackRecTimeMove = 0L;
        trackRecSpeedAvg = 0.0f;
        trackRecSpeedAvgMove = 0.0f;
        trackRecSpeedMax = 0.0f;
        trackRecPoints = 0;
    ...
    protected void readObject(int version, DataReaderBigEndian dr) throws IOException {
        ...
        trackRecDist = dr.readDouble();
        trackRecDistDownhill = dr.readDouble();
        trackRecDistUphill = dr.readDouble();
        trackRecAltMin = dr.readFloat();
        trackRecAltMax = dr.readFloat();
        trackRecAltDownhill = dr.readFloat();
        trackRecAltUphill = dr.readFloat();
        trackRecAltCumulative = dr.readFloat();
        trackRecTime = dr.readLong();
        trackRecTimeMove = dr.readLong();
        trackRecSpeedAvg = dr.readFloat();
        trackRecSpeedAvgMove = dr.readFloat();
        trackRecSpeedMax = dr.readFloat();
        trackRecPoints = dr.readInt();
    ...
    protected void writeObject(DataWriterBigEndian dw) throws IOException {
        ...
        dw.writeDouble(trackRecDist);
        dw.writeDouble(trackRecDistDownhill);
        dw.writeDouble(trackRecDistUphill);
        dw.writeFloat(trackRecAltMin);
        dw.writeFloat(trackRecAltMax);
        dw.writeFloat(trackRecAltDownhill);
        dw.writeFloat(trackRecAltUphill);
        dw.writeFloat(trackRecAltCumulative);
        dw.writeLong(trackRecTime);
        dw.writeLong(trackRecTimeMove);
        dw.writeFloat(trackRecSpeedAvg);
        dw.writeFloat(trackRecSpeedAvgMove);
        dw.writeFloat(trackRecSpeedMax);
        dw.writeInt(trackRecPoints);
